...
import { defineIntegration, logger, getGlobalScope, mergeScopeData, getIsolationScope, getCurrentScope, getFilenameToDebugIdMap, getClient, GLOBAL_OBJ } from '@sentry/core';
...
function disableAnrDetectionForCallback(callback) {
  const integration = _optionalChain([getClient, 'call', _7 => _7(), 'optionalAccess', _8 => _8.getIntegrationByName, 'call', _9 => _9(INTEGRATION_NAME)]) ;
